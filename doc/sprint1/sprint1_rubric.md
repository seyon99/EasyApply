...
Your Mark: 2
Feedback: Missing participants, Release goals need some reference to user stories
...
## User Stories (Tracked in Jira) (max 10 marks) 
  - Correctly formulated user stories (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Make sure you are following the user story format: As a ____, I want to ______, so that ______.
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0
    Feedback: No acceptance criteria defined on Jira 
...
## Tracking on Jira  (max 20 marks) 
  ...
  Your Mark: 0
  Feedback: Missing ticket number for commits
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 3
    Feedback: Software Architecture Diagram provided and follows a general known diagram. However no explanation is provided to describe the diagram.
